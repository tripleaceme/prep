...
export default async function CodingPage() {
  ...
  return (
    <main className="mx-auto max-w-[1100px] px-6 py-10 lg:px-10">
      <h1 className="text-[34px] font-bold">Practice</h1>
      ...
      {/* Subjects first, problems second. A flat list of everything is a wall
          to scroll rather than something to choose from. */}
        ...
        {GROUPS.map((group) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col rounded-[var(--radius)] border border-[var(--border)] bg-[var(--surface)] p-6 transition-colors hover:border-[var(--border-strong)] hover:bg-[var(--surface-2)]"
            >
