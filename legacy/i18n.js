...
(function (global) {
  ...
  DICT.fr["Install"] = "Installer";
  DICT.fr["Add Prep to your home screen, so you can launch it like a native app."] = "Ajoutez Prep à votre écran d'accueil pour le lancer comme une application native.";
  DICT.fr["How"] = "Comment";
  DICT.fr["Hide"] = "Masquer";
  DICT.fr["Dismiss install prompt"] = "Fermer la proposition d'installation";
  DICT.fr["Tap Share icon of your browser, then Add to Home Screen."] = "Appuyez sur l'icône Partager de votre navigateur, puis sur « Sur l'écran d'accueil ».";
  ...
  DICT.de["Install"] = "Installieren";
  DICT.de["Add Prep to your home screen, so you can launch it like a native app."] = "Fügen Sie Prep zum Startbildschirm hinzu, um es wie eine native App zu starten.";
  DICT.de["How"] = "Wie";
  DICT.de["Hide"] = "Ausblenden";
  DICT.de["Dismiss install prompt"] = "Installationshinweis schließen";
  DICT.de["Tap Share icon of your browser, then Add to Home Screen."] = "Tippen Sie auf das Teilen-Symbol Ihres Browsers und dann auf „Zum Home-Bildschirm“.";
